...
describe XPath::HTML do
  ...
  describe '#field' do
    ...
    context "by placeholder" do
      ...
      it("finds select boxes")              { get('select-with-placeholder').should == 'select-with-placeholder-data' }
      it("does not find submit buttons")    { get('input-submit-with-placeholder').should be_nil }
      it("does not find image buttons")     { get('input-image-with-placeholder').should be_nil }
